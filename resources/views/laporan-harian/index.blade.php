                        ...
                        <div class="container">
                            <div class="mx-auto w-full max-w-[510px]">
                                ...
                                <div id="datepicker-container"
                                    class="w-full flex-col rounded-xl bg-white p-4 shadow-four sm:p-[30px] dark:bg-dark-2 dark:shadow-box-dark hidden">
                                    ...
                                    <div
                                        class="grid grid-cols-7 justify-between pb-2 pt-4 text-sm font-medium capitalize text-body-color sm:text-lg dark:text-dark-6">
                                        <span
                    ...
                    <script>
                        ...
                        function renderCalendar() {
                            ...
                            for (let i = 1; i <= daysInMonth; i++) {
                                daysContainer.innerHTML +=
                                    `<div class="flex h-[38px] w-[38px] items-center justify-center rounded-[7px] border-[.5px] border-transparent text-dark hover:border-stroke hover:bg-gray-2 sm:h-[46px] sm:w-[47px] dark:text-white dark:hover:border-dark-3 dark:hover:bg-dark mb-2">${i}</div>`;
                            }

                            document.querySelectorAll('#days-container div').forEach(day => {
                                day.addEventListener('click', function() {
                                    selectedDate = `${month + 1}/${this.textContent}/${year}`;
                                    document.querySelectorAll('#days-container div').forEach(d => d.classList.remove(
