...
<body class="bg-gray-100 font-sans font-semibold">
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-y-auto p-6 relative z-10">
            ...
            <header class="flex justify-between items-center mb-6 relative z-10 bg-white p-3 rounded-md">
                ...
                <h1 class="text-black text-lg font-semibold truncate">Dashboard</h1>
                <div class="ml-auto flex items-center space-x-4">
                    <div class="flex flex-col text-right">
                        <span class="text-black font-semibold text-sm leading-tight truncate max-w-[120px]">
                            {{ Auth::user()->name }}
                        </span>
