...
<head>
    ...
    <title>Page Invoice</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    @vite(['resources/css/app.css', 'resources/js/pembelian.js'])
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-y-auto p-6 relative">
            ...
            <header class="flex justify-between items-center mb-6 relative z-10">
                ...
                <h1 class="text-white text-lg font-semibold truncate">Invoice</h1>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg relative z-10">
                ...
                <section>
                    <x-tabels.tabel-invoice :invoices="$invoices"></x-tabels.tabel-invoice>
                </section>
            </div>
        </div>
    </div>
