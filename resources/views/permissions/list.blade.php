...
<head>
    ...
    <title>Manajemen Utilitas</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-y-auto p-6 relative">
            ...
            <header class="flex justify-between items-center mb-6 relative z-10">
                ...
                <h1 class="text-white text-lg font-semibold truncate">Manajemen Utilitas</h1>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg relative z-10">
                ...
                <nav class="mb-6">
                    <ul class="flex space-x-6">
                        <li>
                            <a class="text-gray-700 pb-2" href="{{ route('permissions.create') }}">
                                Membuat Utilitas
                            </a>
                        </li>
                        <li>
                ...
                <section>
                    <x-tabels.tabel-permissions :permissions="$permissions"></x-tabels.tabel-permissions>
                </section>
            </div>
        </div>
    </div>
