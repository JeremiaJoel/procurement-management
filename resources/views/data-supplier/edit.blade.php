    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-y-auto p-6 relative">
            ...
            <header class="flex justify-between items-center mb-6 relative z-10">
                ...
                <h1 class="text-white text-lg font-semibold truncate">Data Supplier / Edit Supplier</h1>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg relative z-10">
                ...
                <nav class="mb-6">
                    <ul class="flex space-x-6">
                        ...
                        <li>
                            <p class="text-gray-700 pb-2 cursor-pointer" href="{{ route('supplier.create') }}">
                                Add Supplier
                            </p>
                        </li>
                        <li>
                            <a class="text-red-600 border-b-2 border-red-600 pb-2cursor-default"
                                href="{{ route('supplier.edit', $supplier->supplier_id) }}">
                                Edit Supplier
                            </a>
                        </li>
                    </ul>
                ...
                <section>
                    <x-forms.form-edit-supplier :supplier="$supplier"></x-forms.form-supplier>
                </section>
            </div>
        </div>
    </div>
